...
**"Beta test - Release" version 1.01** - "AppImage" build of **_NABU PC MAME_** with Integrated **_NABU NetSim_** (NNS) AppImage Build for Steam Deck.
...
The installed “NABU NetSim” is a fixed version and is not update-able at this time. It is the latest "SD-5" WIP release._
...
./NABUPcNNS.AppImage --nonns nabupc -window -resolution 1024x768 -nabu_video tms9938 -hcca null_modem -bitb socket.192.168.0.211:5816
...
./NABUPcNNS.AppImage --debug nabupc -window -resolution 1024x768 -bios ver14p -hcca null_modem -bitb socket.127.0.0.1:5816
